<div class="carousel-item" style="background-image: url({if $node|has_attribute( 'image' )}{$node|attribute( 'image' ).content[$image_class].url|ezroot(no)}){else}{'images/bg-owl_carousel_subheader_item.jpg'|ezdesign(no)}{/if}">
