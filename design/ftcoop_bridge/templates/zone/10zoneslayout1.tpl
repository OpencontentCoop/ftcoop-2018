  ...
  <div class="{if $add_max_width}max-width{/if}">	
	  ...
	  <div class="col-md-6">
		...
		{foreach $zones[6].blocks as $block}
			{include uri='design:parts/zone_block.tpl' zone=$zones[6] items_per_row=1}
		{/foreach}
		{/if}
	  </div>
  </div>
  ...
  <div class="{if $add_max_width}max-width{/if}">		
	  <div class="col-md-4">
		...
		{foreach $zones[7].blocks as $block}
			{include uri='design:parts/zone_block.tpl' zone=$zones[7] items_per_row=1}
		{/foreach}
		{/if}
	  </div>
	  <div class="col-md-4">
		...
		{foreach $zones[8].blocks as $block}
			{include uri='design:parts/zone_block.tpl' zone=$zones[8] items_per_row=1}
		{/foreach}
		{/if}
	  </div>
	  <div class="col-md-4">
		...
		{foreach $zones[9].blocks as $block}
			{include uri='design:parts/zone_block.tpl' zone=$zones[9] items_per_row=1}
		{/foreach}
		{/if}
	  </div>
  </div>
